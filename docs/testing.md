...
- Preflight: run `00_preflight.yml`; confirm interfaces, destination object, and policy ID are safe.
...
- Policy create: verify policy ID 9001, references, action, interfaces, schedule, NAT, and logging.
