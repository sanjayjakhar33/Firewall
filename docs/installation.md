...
Push that image to a registry reachable by AWX and select it on the job templates. No FortiGate collection is required; the playbooks use Ansible's built-in URI module.
